...
namespace Com.Singular.Sdk {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.singular.sdk']/class[@name='SingularInstallReceiver']"
	[global::Android.Runtime.Register ("com/singular/sdk/SingularInstallReceiver", DoNotGenerateAcw=true)]
	public partial class SingularInstallReceiver : global::Android.Content.BroadcastReceiver {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/singular/sdk/SingularInstallReceiver", typeof (SingularInstallReceiver));
		...
		protected SingularInstallReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.singular.sdk']/class[@name='SingularInstallReceiver']/constructor[@name='SingularInstallReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe SingularInstallReceiver () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Singular.Sdk.SingularInstallReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.singular.sdk']/class[@name='SingularInstallReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
