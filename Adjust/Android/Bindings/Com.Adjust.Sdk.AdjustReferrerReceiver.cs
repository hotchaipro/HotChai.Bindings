...
namespace Com.Adjust.Sdk {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.adjust.sdk']/class[@name='AdjustReferrerReceiver']"
	[global::Android.Runtime.Register ("com/adjust/sdk/AdjustReferrerReceiver", DoNotGenerateAcw=true)]
	public partial class AdjustReferrerReceiver : global::Android.Content.BroadcastReceiver {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/adjust/sdk/AdjustReferrerReceiver", typeof (AdjustReferrerReceiver));
		...
		protected AdjustReferrerReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.adjust.sdk']/class[@name='AdjustReferrerReceiver']/constructor[@name='AdjustReferrerReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe AdjustReferrerReceiver () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Adjust.Sdk.AdjustReferrerReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.adjust.sdk']/class[@name='AdjustReferrerReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
