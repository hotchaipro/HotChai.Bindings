...
namespace IronSourceSdk {
	...
	public unsafe partial class ISBaseAdUnitAdapter : NSObject, IISNetworkInitCallbackProtocol {
		...
		public virtual string GetMissingParamErrorStringWithKey (string key)
		{
			...
			string? ret;
			if (IsDirectBinding) {
				ret = CFString.FromHandle (ApiDefinitions.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("getMissingParamErrorStringWithKey:"), nskey))!;
			} else {
				ret = CFString.FromHandle (ApiDefinitions.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (this.SuperHandle, Selector.GetHandle ("getMissingParamErrorStringWithKey:"), nskey))!;
			}
		...
		public virtual string GetStringValueFromAdapterConfig (ISAdapterConfig adapterConfig, string key)
		{
			...
			string? ret;
			if (IsDirectBinding) {
				ret = CFString.FromHandle (ApiDefinitions.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("getStringValueFromAdapterConfig:forKey:"), adapterConfig__handle__, nskey))!;
			} else {
				ret = CFString.FromHandle (ApiDefinitions.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (this.SuperHandle, Selector.GetHandle ("getStringValueFromAdapterConfig:forKey:"), adapterConfig__handle__, nskey))!;
			}
			CFString.ReleaseNative (nskey);
			return ret!;
		}
