...
namespace IronSourceSdk {
	...
	public unsafe partial class ISDemandOnlyBannerView : global::UIKit.UIView {
		...
		public static new ISDemandOnlyBannerViewAppearance Appearance {
			get { return new ISDemandOnlyBannerViewAppearance (global::IronSourceSdk.ApiDefinitions.Messaging.IntPtr_objc_msgSend (class_ptr, ObjCRuntime.Selector.GetHandle ("appearance"))); }
		}
		public static new ISDemandOnlyBannerViewAppearance GetAppearance<T> () where T: ISDemandOnlyBannerView {
			return new ISDemandOnlyBannerViewAppearance (global::IronSourceSdk.ApiDefinitions.Messaging.IntPtr_objc_msgSend (Class.GetHandle (typeof (T)), ObjCRuntime.Selector.GetHandle ("appearance")));
		}
