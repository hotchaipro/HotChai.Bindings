...
namespace IronSourceSdk {
	...
	public unsafe partial class ISNEventTrackerWrapper : NSObject, IISNEventTrackerInterface {
		...
		public virtual void Data (ISNEvent @event, NSDictionary data)
		{
			...
			if (IsDirectBinding) {
				global::IronSourceSdk.ApiDefinitions.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("logEvent:data:"), @event__handle__, data__handle__);
			} else {
				global::IronSourceSdk.ApiDefinitions.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (this.SuperHandle, Selector.GetHandle ("logEvent:data:"), @event__handle__, data__handle__);
			}
		}
