...
namespace Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.ironsource.mediationsdk.adunit.adapter.internal.listener']/interface[@name='AdapterAdInteractionListener']"
	[Register ("com/ironsource/mediationsdk/adunit/adapter/internal/listener/AdapterAdInteractionListener", "", "Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener.IAdapterAdInteractionListenerInvoker")]
	public partial interface IAdapterAdInteractionListener : global::Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener.IAdapterAdListener {
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ironsource.mediationsdk.adunit.adapter.internal.listener']/interface[@name='AdapterAdInteractionListener']/method[@name='onAdClosed' and count(parameter)=0]"
		[Register ("onAdClosed", "()V", "GetOnAdClosedHandler:Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener.IAdapterAdInteractionListenerInvoker, MatchSolitaire.Android")]
		void OnAdClosed ();

		// Metadata.xml XPath method reference: path="/api/package[@name='com.ironsource.mediationsdk.adunit.adapter.internal.listener']/interface[@name='AdapterAdInteractionListener']/method[@name='onAdEnded' and count(parameter)=0]"
		[Register ("onAdEnded", "()V", "GetOnAdEndedHandler:Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener.IAdapterAdInteractionListenerInvoker, MatchSolitaire.Android")]
		void OnAdEnded ();

		// Metadata.xml XPath method reference: path="/api/package[@name='com.ironsource.mediationsdk.adunit.adapter.internal.listener']/interface[@name='AdapterAdInteractionListener']/method[@name='onAdShowFailed' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='java.lang.String']]"
		[Register ("onAdShowFailed", "(ILjava/lang/String;)V", "GetOnAdShowFailed_ILjava_lang_String_Handler:Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener.IAdapterAdInteractionListenerInvoker, MatchSolitaire.Android")]
		void OnAdShowFailed (int p0, string p1);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.ironsource.mediationsdk.adunit.adapter.internal.listener']/interface[@name='AdapterAdInteractionListener']/method[@name='onAdShowSuccess' and count(parameter)=0]"
		[Register ("onAdShowSuccess", "()V", "GetOnAdShowSuccessHandler:Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener.IAdapterAdInteractionListenerInvoker, MatchSolitaire.Android")]
		void OnAdShowSuccess ();

		// Metadata.xml XPath method reference: path="/api/package[@name='com.ironsource.mediationsdk.adunit.adapter.internal.listener']/interface[@name='AdapterAdInteractionListener']/method[@name='onAdStarted' and count(parameter)=0]"
		[Register ("onAdStarted", "()V", "GetOnAdStartedHandler:Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener.IAdapterAdInteractionListenerInvoker, MatchSolitaire.Android")]
		void OnAdStarted ();

		// Metadata.xml XPath method reference: path="/api/package[@name='com.ironsource.mediationsdk.adunit.adapter.internal.listener']/interface[@name='AdapterAdInteractionListener']/method[@name='onAdVisible' and count(parameter)=0]"
		[Register ("onAdVisible", "()V", "GetOnAdVisibleHandler:Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener.IAdapterAdInteractionListenerInvoker, MatchSolitaire.Android")]
		void OnAdVisible ();

	}

	[global::Android.Runtime.Register ("com/ironsource/mediationsdk/adunit/adapter/internal/listener/AdapterAdInteractionListener", DoNotGenerateAcw=true)]
	internal partial class IAdapterAdInteractionListenerInvoker : global::Java.Lang.Object, IAdapterAdInteractionListener {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/ironsource/mediationsdk/adunit/adapter/internal/listener/AdapterAdInteractionListener", typeof (IAdapterAdInteractionListenerInvoker));
		...
		public static IAdapterAdInteractionListener GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IAdapterAdInteractionListener> (handle, transfer);
		}

		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'com.ironsource.mediationsdk.adunit.adapter.internal.listener.AdapterAdInteractionListener'.");
			return handle;
		}
		...
		public IAdapterAdInteractionListenerInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener.IAdapterAdInteractionListener> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.OnAdClosed ();
		}
