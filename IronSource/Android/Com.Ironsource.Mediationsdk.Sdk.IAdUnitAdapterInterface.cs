...
namespace Com.IronSource.MediationSdk.Sdk {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.ironsource.mediationsdk.sdk']/interface[@name='AdUnitAdapterInterface']"
	[Register ("com/ironsource/mediationsdk/sdk/AdUnitAdapterInterface", "", "Com.IronSource.MediationSdk.Sdk.IAdUnitAdapterInterfaceInvoker")]
	public partial interface IAdUnitAdapterInterface : global::Com.IronSource.MediationSdk.INetworkInitCallbackListener, global::Com.IronSource.MediationSdk.Sdk.IReleaseMemoryAdapterInterface {
	}

	[global::Android.Runtime.Register ("com/ironsource/mediationsdk/sdk/AdUnitAdapterInterface", DoNotGenerateAcw=true)]
	internal partial class IAdUnitAdapterInterfaceInvoker : global::Java.Lang.Object, IAdUnitAdapterInterface {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/ironsource/mediationsdk/sdk/AdUnitAdapterInterface", typeof (IAdUnitAdapterInterfaceInvoker));
		...
		public static IAdUnitAdapterInterface GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IAdUnitAdapterInterface> (handle, transfer);
		}

		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'com.ironsource.mediationsdk.sdk.AdUnitAdapterInterface'.");
			return handle;
		}
		...
		public IAdUnitAdapterInterfaceInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.IronSource.MediationSdk.Sdk.IAdUnitAdapterInterface> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
