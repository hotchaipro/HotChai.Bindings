...
namespace Com.IronSource.MediationSdk.AdUnit.Adapter.Listener {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.ironsource.mediationsdk.adunit.adapter.listener']/interface[@name='InterstitialAdListener']"
	[Register ("com/ironsource/mediationsdk/adunit/adapter/listener/InterstitialAdListener", "", "Com.IronSource.MediationSdk.AdUnit.Adapter.Listener.IInterstitialAdListenerInvoker")]
	public partial interface IInterstitialAdListener : global::Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener.IAdapterAdInteractionListener {
	}

	[global::Android.Runtime.Register ("com/ironsource/mediationsdk/adunit/adapter/listener/InterstitialAdListener", DoNotGenerateAcw=true)]
	internal partial class IInterstitialAdListenerInvoker : global::Java.Lang.Object, IInterstitialAdListener {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/ironsource/mediationsdk/adunit/adapter/listener/InterstitialAdListener", typeof (IInterstitialAdListenerInvoker));
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'com.ironsource.mediationsdk.adunit.adapter.listener.InterstitialAdListener'.");
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.IronSource.MediationSdk.AdUnit.Adapter.Listener.IInterstitialAdListener> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.OnAdClosed ();
		}
