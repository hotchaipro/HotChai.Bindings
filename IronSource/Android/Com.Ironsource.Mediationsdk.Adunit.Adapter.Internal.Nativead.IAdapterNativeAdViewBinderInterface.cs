...
namespace Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.NativeAd {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.ironsource.mediationsdk.adunit.adapter.internal.nativead']/interface[@name='AdapterNativeAdViewBinderInterface']"
	[Register ("com/ironsource/mediationsdk/adunit/adapter/internal/nativead/AdapterNativeAdViewBinderInterface", "", "Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.NativeAd.IAdapterNativeAdViewBinderInterfaceInvoker")]
	public partial interface IAdapterNativeAdViewBinderInterface : global::Com.IronSource.MediationSdk.Ads.NativeAd.Interfaces.INativeAdViewBinderInterface {
		global::Android.Views.ViewGroup NetworkNativeAdView {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ironsource.mediationsdk.adunit.adapter.internal.nativead']/interface[@name='AdapterNativeAdViewBinderInterface']/method[@name='getNetworkNativeAdView' and count(parameter)=0]"
			[Register ("getNetworkNativeAdView", "()Landroid/view/ViewGroup;", "GetGetNetworkNativeAdViewHandler:Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.NativeAd.IAdapterNativeAdViewBinderInterfaceInvoker, MatchSolitaire.Android")]
			get; 
		}
		...
		[Register ("setNativeAdView", "(Landroid/view/View;)V", "GetSetNativeAdView_Landroid_view_View_Handler:Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.NativeAd.IAdapterNativeAdViewBinderInterfaceInvoker, MatchSolitaire.Android")]
		void SetNativeAdView (global::Android.Views.View nativeAdView);

	}

	[global::Android.Runtime.Register ("com/ironsource/mediationsdk/adunit/adapter/internal/nativead/AdapterNativeAdViewBinderInterface", DoNotGenerateAcw=true)]
	internal partial class IAdapterNativeAdViewBinderInterfaceInvoker : global::Java.Lang.Object, IAdapterNativeAdViewBinderInterface {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/ironsource/mediationsdk/adunit/adapter/internal/nativead/AdapterNativeAdViewBinderInterface", typeof (IAdapterNativeAdViewBinderInterfaceInvoker));
		...
		public static IAdapterNativeAdViewBinderInterface GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IAdapterNativeAdViewBinderInterface> (handle, transfer);
		}

		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'com.ironsource.mediationsdk.adunit.adapter.internal.nativead.AdapterNativeAdViewBinderInterface'.");
			return handle;
		}
		...
		public IAdapterNativeAdViewBinderInterfaceInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.NativeAd.IAdapterNativeAdViewBinderInterface> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.NetworkNativeAdView);
		}
#pragma warning restore 0169

		IntPtr id_getNetworkNativeAdView;
		public unsafe global::Android.Views.ViewGroup NetworkNativeAdView {
			get {
				if (id_getNetworkNativeAdView == IntPtr.Zero)
					id_getNetworkNativeAdView = JNIEnv.GetMethodID (class_ref, "getNetworkNativeAdView", "()Landroid/view/ViewGroup;");
				return global::Java.Lang.Object.GetObject<global::Android.Views.ViewGroup> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getNetworkNativeAdView), JniHandleOwnership.TransferLocalRef);
			}
		}
...
#pragma warning restore 0169
		...
		IntPtr id_setNativeAdView_Landroid_view_View_;
		public unsafe void SetNativeAdView (global::Android.Views.View nativeAdView)
		{
			if (id_setNativeAdView_Landroid_view_View_ == IntPtr.Zero)
				id_setNativeAdView_Landroid_view_View_ = JNIEnv.GetMethodID (class_ref, "setNativeAdView", "(Landroid/view/View;)V");
			JValue* __args = stackalloc JValue [1];
			__args [0] = new JValue ((nativeAdView == null) ? IntPtr.Zero : ((global::Java.Lang.Object) nativeAdView).Handle);
			JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_setNativeAdView_Landroid_view_View_, __args);
		}
