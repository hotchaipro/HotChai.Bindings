...
namespace Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.ironsource.mediationsdk.adunit.adapter.internal.listener']/interface[@name='AdapterAdViewListener']"
	[Register ("com/ironsource/mediationsdk/adunit/adapter/internal/listener/AdapterAdViewListener", "", "Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener.IAdapterAdViewListenerInvoker")]
	public partial interface IAdapterAdViewListener : global::Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener.IAdapterAdListener {
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ironsource.mediationsdk.adunit.adapter.internal.listener']/interface[@name='AdapterAdViewListener']/method[@name='onAdLeftApplication' and count(parameter)=0]"
		[Register ("onAdLeftApplication", "()V", "GetOnAdLeftApplicationHandler:Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener.IAdapterAdViewListenerInvoker, MatchSolitaire.Android")]
		void OnAdLeftApplication ();

		// Metadata.xml XPath method reference: path="/api/package[@name='com.ironsource.mediationsdk.adunit.adapter.internal.listener']/interface[@name='AdapterAdViewListener']/method[@name='onAdLoadSuccess' and count(parameter)=2 and parameter[1][@type='android.view.View'] and parameter[2][@type='android.widget.FrameLayout.LayoutParams']]"
		[Register ("onAdLoadSuccess", "(Landroid/view/View;Landroid/widget/FrameLayout$LayoutParams;)V", "GetOnAdLoadSuccess_Landroid_view_View_Landroid_widget_FrameLayout_LayoutParams_Handler:Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener.IAdapterAdViewListenerInvoker, MatchSolitaire.Android")]
		void OnAdLoadSuccess (global::Android.Views.View p0, global::Android.Widget.FrameLayout.LayoutParams p1);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.ironsource.mediationsdk.adunit.adapter.internal.listener']/interface[@name='AdapterAdViewListener']/method[@name='onAdScreenDismissed' and count(parameter)=0]"
		[Register ("onAdScreenDismissed", "()V", "GetOnAdScreenDismissedHandler:Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener.IAdapterAdViewListenerInvoker, MatchSolitaire.Android")]
		void OnAdScreenDismissed ();

		// Metadata.xml XPath method reference: path="/api/package[@name='com.ironsource.mediationsdk.adunit.adapter.internal.listener']/interface[@name='AdapterAdViewListener']/method[@name='onAdScreenPresented' and count(parameter)=0]"
		[Register ("onAdScreenPresented", "()V", "GetOnAdScreenPresentedHandler:Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener.IAdapterAdViewListenerInvoker, MatchSolitaire.Android")]
		void OnAdScreenPresented ();

	}

	[global::Android.Runtime.Register ("com/ironsource/mediationsdk/adunit/adapter/internal/listener/AdapterAdViewListener", DoNotGenerateAcw=true)]
	internal partial class IAdapterAdViewListenerInvoker : global::Java.Lang.Object, IAdapterAdViewListener {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/ironsource/mediationsdk/adunit/adapter/internal/listener/AdapterAdViewListener", typeof (IAdapterAdViewListenerInvoker));
		...
		public static IAdapterAdViewListener GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IAdapterAdViewListener> (handle, transfer);
		}

		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'com.ironsource.mediationsdk.adunit.adapter.internal.listener.AdapterAdViewListener'.");
			return handle;
		}
		...
		public IAdapterAdViewListenerInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener.IAdapterAdViewListener> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
