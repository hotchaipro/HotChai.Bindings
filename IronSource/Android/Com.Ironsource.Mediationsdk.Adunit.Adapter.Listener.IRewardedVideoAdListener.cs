...
namespace Com.IronSource.MediationSdk.AdUnit.Adapter.Listener {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.ironsource.mediationsdk.adunit.adapter.listener']/interface[@name='RewardedVideoAdListener']"
	[Register ("com/ironsource/mediationsdk/adunit/adapter/listener/RewardedVideoAdListener", "", "Com.IronSource.MediationSdk.AdUnit.Adapter.Listener.IRewardedVideoAdListenerInvoker")]
	public partial interface IRewardedVideoAdListener : global::Com.IronSource.MediationSdk.AdUnit.Adapter.Internal.Listener.IAdapterAdRewardListener {
	}

	[global::Android.Runtime.Register ("com/ironsource/mediationsdk/adunit/adapter/listener/RewardedVideoAdListener", DoNotGenerateAcw=true)]
	internal partial class IRewardedVideoAdListenerInvoker : global::Java.Lang.Object, IRewardedVideoAdListener {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/ironsource/mediationsdk/adunit/adapter/listener/RewardedVideoAdListener", typeof (IRewardedVideoAdListenerInvoker));
		...
		public static IRewardedVideoAdListener GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IRewardedVideoAdListener> (handle, transfer);
		}

		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'com.ironsource.mediationsdk.adunit.adapter.listener.RewardedVideoAdListener'.");
			return handle;
		}
		...
		public IRewardedVideoAdListenerInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.IronSource.MediationSdk.AdUnit.Adapter.Listener.IRewardedVideoAdListener> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.OnAdRewarded ();
		}
