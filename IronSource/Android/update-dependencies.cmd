...
:: Remove dependencies already included in NuGet packages (see gradle dependencies)
...
del %~dp0NativeDependencies\installreferrer-*.aar
...
:: del %~dp0NativeDependencies\lifecycle-livedata-core-2.0.0.aar
