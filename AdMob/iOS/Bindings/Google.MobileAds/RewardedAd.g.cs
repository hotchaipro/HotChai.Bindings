...
{
    [Register("GADRewardedAd", true)]
	public unsafe partial class RewardedAd : FullScreenPresentingAd, IAdMetadataProvider {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("GADRewardedAd");
		public override NativeHandle ClassHandle { get { return class_ptr; } }
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public RewardedAd () : base (NSObjectFlag.Empty)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected RewardedAd (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::Google.MobileAds.ObjCRuntime.Messaging.this_assembly;
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal RewardedAd (NativeHandle handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::Google.MobileAds.ObjCRuntime.Messaging.this_assembly;
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void Load (string adUnitId, Request? request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDRewardedAdLoadCompletionHandler))]RewardedAdLoadCompletionHandler completionHandler)
		{
			if (adUnitId is null)
			...
			using var block_completionHandler = Trampolines.SDRewardedAdLoadCompletionHandler.CreateBlock (completionHandler);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static Task<RewardedAd> LoadAsync (string adUnitId, Request? request)
		{
			var tcs = new TaskCompletionSource<RewardedAd> ();
			Load(adUnitId, request, (rewardedAd_, error_) => {
				if (error_ != null)
					tcs.SetException (new NSErrorException(error_));
				else
					tcs.SetResult (rewardedAd_!);
			});
			return tcs.Task;
		}
		[Export ("presentFromRootViewController:userDidEarnRewardHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void Present (global::UIKit.UIViewController viewController, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDUserDidEarnRewardHandler))]UserDidEarnRewardHandler userDidEarnRewardHandler)
		{
			var viewController__handle__ = viewController!.GetNonNullHandle (nameof (viewController));
			if (userDidEarnRewardHandler is null)
				ThrowHelper.ThrowArgumentNullException (nameof (userDidEarnRewardHandler));
			using var block_userDidEarnRewardHandler = Trampolines.SDUserDidEarnRewardHandler.CreateBlock (userDidEarnRewardHandler);
			BlockLiteral *block_ptr_userDidEarnRewardHandler = &block_userDidEarnRewardHandler;
			if (IsDirectBinding) {
				global::Google.MobileAds.ObjCRuntime.Messaging.void_objc_msgSend_IntPtr_IntPtr (this.Handle, Selector.GetHandle ("presentFromRootViewController:userDidEarnRewardHandler:"), viewController__handle__, (NativeHandle) block_ptr_userDidEarnRewardHandler);
			} else {
				global::Google.MobileAds.ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr_IntPtr (this.SuperHandle, Selector.GetHandle ("presentFromRootViewController:userDidEarnRewardHandler:"), viewController__handle__, (NativeHandle) block_ptr_userDidEarnRewardHandler);
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual AdReward AdReward {
			[Export ("adReward")]
			get {
				AdReward? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<AdReward> (global::Google.MobileAds.ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("adReward")))!;
				} else {
					ret =  Runtime.GetNSObject<AdReward> (global::Google.MobileAds.ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("adReward")))!;
				}
				return ret!;
			}
		}
